...
HttpResponse::HttpResponse(TCPConnection* conn) : status_code_(200), reason_phrase_("OK"), has_body_(false), has_file_(false), conn_(conn) { }
...
void HttpResponse::SetBody(const string& body) {body_ = body;}
